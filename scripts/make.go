...
const DelveMainPackagePath = "github.com/lupes/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/lupes/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/lupes/delve/pkg/proc", "github.com/lupes/delve/service/test", "github.com/lupes/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/lupes/delve/service/test"}
